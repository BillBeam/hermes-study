...
> L1 的轨迹是 412(R1)→ 436(R6)→ 446(R7C)→ 461(R8A)→ **511**(R8B),L2 相应递减。
...
L3 / L4 / LT 三层连续五轮一字未动,所以**光看分层表会以为项目没在动,也读不出还剩多少**
(review-1 建议-21 / M-25)。

一个反直觉的数字:**测试(756,619 行)比核心机制(479,923 行)还多**。这不是坏事——它意味着几乎每个
